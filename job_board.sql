...
--
-- Hôte : localhost:8889
-- Généré le : mer. 12 oct. 2022 à 14:52
...
(5, 'hugo.massaria@gmail.com', 26, '0627495848', 'Hugo', 'Massaria');
...
--
ALTER TABLE `advertisements`
  MODIFY `id_advertisement` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT pour la table `applications`
--
ALTER TABLE `applications`
  MODIFY `id_application` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
